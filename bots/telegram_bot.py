#!/usr/bin/env python3
"""
Telegram-бот для RAG-сервиса грантовых документов.
Взаимодействует с FastAPI-бэкендом, поддерживает PDF и DOCX,
историю диалога, команды, персистентность и устойчивость к ошибкам.
"""
